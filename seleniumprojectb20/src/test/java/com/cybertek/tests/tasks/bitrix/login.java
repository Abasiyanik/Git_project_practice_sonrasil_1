package com.cybertek.tests.tasks.bitrix;
...
*/
    ...
    public void open_web_page() {
        ...
        Driver.getDriver().findElement(By.name("USER_LOGIN")).sendKeys(ConfigurationReader.getProperty("bitusername"));
        Driver.getDriver().findElement(By.name("USER_PASSWORD")).sendKeys(ConfigurationReader.getProperty("bitpassword"));
